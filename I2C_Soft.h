...
#define SCL_PIN         PORTBbits.RB4           // set port definitions
#define SCL_DIR         PORTBbits.RB4           // set port definitions
#define SDA_PIN         PORTDbits.RD7           // set port definitions
#define SDA_DIR         PORTDbits.RD7           // set port definitions
